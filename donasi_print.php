...
if($_SESSION['suser'] =='admin'){
	...
	$kodedons = $_SESSION['skodedonatur'];
	$sql = "SELECT * FROM transaksi_donasi WHERE id_donatur='$kodedons'";
}
...
<table border=0 cellpadding=0 cellspacing=0 width=1206 style='border-collapse:
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  <td class=xl6629397 width=163 style='width:124pt'></td>
  <td class=asemanjenk colspan=3 style='width:207pt'><span
  style='mso-spacerun:yes'>   </span>LAPORAN DATA TRANSAKSI DONASI</td>
 ...
 <tr height=32 style='mso-height-source:userset;height:24.0pt'>
  ...
  <td class=xl6329397></td>
  <td class=xl6329397></td>
  <td align="center" class=xl6329397 colspan="3">Jl. Wahidin No.22 Cirebon</td>
  <td class=xl6329397></td>
  <td class=xl6329397></td>
 </tr>
...
>
	<thead>
		<tr height=20 style='height:15.0pt'>
			...
			<td class=xl6729397 width="20">ID</td>
			<td class=xl6829397 width="150">Kode Donatur</td>
			<td class=xl6829397 width="100">Kode Transaksi</td>
			<td class=xl6829397 width="250">Nominal</td>
			<td class=xl6829397 width="150">Tanggal transaksi</td>
			<td class=xl6829397 width="100">No Rekening</td>
			<td class=xl6829397 width="105">Nama Rekening</td>
			<td class=xl6829397 width="100">Bank</td>
			<td class=xl6829397 width="170">Gambar</td>
			<td class=xl6829397 width="100">Jam</td>
			<td class=xl6829397 width="100">Konfirmasi</td>
		</tr>
	</thead>
	<tbody>
<?php
...
?>    
		<tr>
			...
			<td><center><?php echo $data['id_donatur'] ?></center></td>
			<td><center><?php echo $data['kode_transaksi'] ?></center></td>
			...
			<td><center><?php echo $data['bank'] ?></center></td>
			<td><center><?php echo $data['gambar'] ?></center></td>
			<td><center><?php echo $data['jam'] ?></center></td>
			<td><center><?php echo $data['konfirmasi'] ?></center></td>	
		</tr>
<?php
		$i++;
}
