...
<table border=0 cellpadding=0 cellspacing=0 width=1206 style='border-collapse:
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  style='mso-spacerun:yes'>   </span>LAPORAN DATA DONATUR</td>
...
>
	<thead>
		<tr height=20 style='height:15.0pt'>
			...
			<td class=xl6829397 width="95">Username</td>
			<td class=xl6829397 width="250">Password</td>
			<td class=xl6829397 width="150">Nama Lengkap</td>
			<td class=xl6829397 width="100">Jenis Kelamin</td>
			<td class=xl6829397 width="100">Tempat Lahir</td>
			<td class=xl6829397 width="100">Tanggal Lahir</td>
			<td class=xl6829397 width="170">Email</td>
			<td class=xl6829397 width="100">No Handphone</td>
			<td class=xl6829397 width="100">Alamat</td>
			<td class=xl6829397 width="50">ID Level</td>
		</tr>
	</thead>
	<tbody>
<?php
...
?>    
		<tr>
			...
			<td><center><?php echo $data['kode_donatur'] ?></center></td>
			...
			<td><center><?php echo $data['id_level'] ?></center></td>		
		</tr>
<?php
		$i++;
}
