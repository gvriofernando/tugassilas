...
if($_SESSION['suser'] =='admin'){
	...
	$sql = "SELECT * FROM pengeluaran WHERE id_donatur='$kodedons'" ;
}
...
<table border=0 cellpadding=0 cellspacing=0 width=1206 style='border-collapse:
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  style='mso-spacerun:yes'>   </span>LAPORAN DATA PENGELUARAN</td>
...
>
	<thead>
		<tr height=20 style='height:15.0pt'>
			...
			<td class=xl6829397 width="150">ID Donatur</td>
			<td class=xl6829397 width="95">ID Anak</td>
			<td class=xl6829397 width="250">Jumlah</td>
			<td class=xl6829397 width="150">Keterangan</td>
		</tr>
	</thead>
	<tbody>
<?php
...
?>    
		<tr>
			...
			<td><center><?php echo $data['id_ank'] ?></center></td>
